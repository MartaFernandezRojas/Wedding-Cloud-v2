                ...
                <MDBCard className="card-body #455a64 blue-grey darken-1" style={{ width: "20rem", marginTop: "1rem" }}>
                    <div className={styles.fondo}>
                        <div className="row"><div className="col l6">
                            <img src={avatar} className={styles.img} /></div><div className="col l6"><h3 className={styles.titulo}>{this.props.mensaje.nombre}</h3><p className={styles.mensaje}>{this.props.mensaje.familia} de {this.props.mensaje.parte}</p></div>
                        </div>
